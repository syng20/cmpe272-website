<?php
    ...
    $retrieved = json_decode($v, true); 
    // if (array_key_exists('prbh', $retrieved)) {
    //     unset($retrieved['prbh']); 
    // }
    // $retrieved['prbh'] = "Pear Blossom Honey"; 
    ...
    $retrieved['prbh'] = 1; 
    if (($nz_counter >= 5) && ('prbh' !=$largest_n)) {
...
<body>
    ...
    <h2>Pear Blossom Honey</h2>

    <main class="productsection">
        <div class="productsection_i">
            <img src="../img/pear_blossom_honey.jpg">
        </div>
        <div class="productsection_t"> 
            <p><strong>Contents:</strong>
            A jar of pear blossom honey. Each jar is 12 oz.
            <br>
            <strong>Price:</strong>
            $15.00 per jar</p>
        </div>
