<?php
    // for most visited 
    $hc = $_COOKIE["visits[hc]"]; 
    $hc++; 
    setcookie("visits[hc]", $hc); 
    // for most recently visited
    $hc = $_COOKIE["recent[hc]"]; 
    $hc++; 
    setcookie("recent[hc]", $hc); 
    $nz_counter = 0; 
    $largest_n = ""; 
    $largest_v = 0; 
...
<body>
    ...
    <main class="productsection">
        <div class="productsection_i">
            <img src="../img/honeycomb.jpg">
        </div>
        <div class="productsection_t"> 
            <p><strong>Contents:</strong>
            A jar of honeycomb preserved within wildflower honey. Each jar is 12 oz.
            <br>
            <strong>Price:</strong>
            $25.00 per jar</p>
        </div>
